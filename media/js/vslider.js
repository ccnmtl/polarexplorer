...
$.widget( "mobile.verticalslider", $.mobile.widget, $.extend( {
    ...
    options: {
        ...
        trackTheme: null,
        disabled: false,
        initSelector: "input[type='vrange'], :jqmData(type='vrange'), :jqmData(role='verticalslider')",
        mini: false,
        highlight: false
    },
    ...
    _create: function() {
        ...
        var self = this,
            ...
            isRangeslider = control.parent().is( ":jqmData(role='vrangeslider')" ),
            selectClass = ( this.isToggleSwitch ) ? "ui-slider-vertical-switch" : "",
            ...
            valuebg = this.options.highlight && !this.isToggleSwitch ? (function() {
                ...
                bg.className = "ui-slider-vertical-bg " + $.mobile.activeBtnClass;
        ...
        domSlider.className = [this.isToggleSwitch ? "ui-slider-vertical " : "ui-slider-vertical-track ",selectClass," ui-btn-down-",trackTheme," ", miniClass].join( "" );
        ...
        if ( this.isToggleSwitch ) {
            ...
            for ( var i = 0, optionsCount = options.length; i < optionsCount; i++ ) {
                ...
                sliderImg.className = ["ui-slider-vertical-label ui-slider-vertical-label-", side, sliderTheme, " "].join( "" );
        ...
        control.addClass( this.isToggleSwitch ? "ui-slider-vertical-switch" : "ui-slider-vertical-input" );
        ...
        if ( !this.isToggleSwitch && !isRangeslider ) {
            wrapper = this.options.mini ? "<div class='ui-slider-vertical ui-mini'>" : "<div class='ui-slider-vertical'>";
    ...
    _preventDocumentDrag: function( event ) {
            ...
            if ( this.dragging && !this.options.disabled ) {
                ...
                if ( this.isToggleSwitch ) {
                    ...
                    this.handle.removeClass( "ui-slider-vertical-handle-snapping" );
                }
    ...
    refresh: function( val, isfromControl, preventInputUpdate ) {
        ...
        self.slider[0].className = [ this.isToggleSwitch ? "ui-slider-vertical ui-slider-vertical-switch" : "ui-slider-vertical-track"," ui-btn-down-" + trackTheme,' ', ( this.options.mini ) ? " ui-mini":""].join( "" );
        ...
        if ( this.options.highlight && !this.isToggleSwitch && this.slider.find( ".ui-slider-vertical-bg" ).length === 0 ) {
        ...
        if ( this._labels ) {
            var handlePercent = this.handle.height() / this.slider.height() * 100,
